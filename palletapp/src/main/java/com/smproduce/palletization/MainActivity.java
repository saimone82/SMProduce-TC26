package com.smproduce.palletization;
...
public class MainActivity extends Activity {
    private static final String PROFILE = "SM_PRODUCE_PALLETIZATION";
    ...
    @Override public void onCreate(Bundle state) {
        ...
        s.setUserAgentString(s.getUserAgentString() + " SMProduceTC26-Palletization/1.0");
        ...
        if (state == null) web.loadUrl(BuildConfig.PAGE_URL);
    ...
    private void setupDataWedge() {
        Bundle create = baseProfile("CREATE_IF_NOT_EXIST");
        sendSetConfig(create);
